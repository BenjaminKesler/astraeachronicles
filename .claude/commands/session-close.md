...
8. On approval: run `git add -A`, commit using the approved message, then `git push`.
9. Confirm the commit and push succeeded and tell the user they are ready to `/clear`.
