...
CONVENTIONS
  ...
  ✓ = theory captured  |  → = cross-ref to existing file  |  [stub] = pending video
...
mechanism: ✓ → Beats/01_hook.md (wound layer, genre contract, sympathy layer, relational layer: establish + universal calibration principles, design requirements, diagnostics)
...
mechanism: ✓ → Beats/02_inciting_incident.md (wound layer: comfort zone as mechanism's defended territory, desire crystallization; genre layer: value swing, story question activation, world as delivery vehicle; sympathy layer: wound-specific calibration as multiplier, pity trap; relational layer: first contact, first relational consequence; failure mode: PLOT EVENT)
